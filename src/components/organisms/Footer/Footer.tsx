...
export const Footer: FC<FooterProps> = ({ person }) => {
  return (
...
//                       className='text-xs leading-none text-gray-800 lg:text-sm hover:text-brand-dark dark:hover:text-brand-light dark:text-gray-50'>
//                       Documentation
//                     </a>
//                   </li>
//                 </ul>
