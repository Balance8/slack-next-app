          ...
          <div className='lg:flex'>
            <div className='flex w-full mb-16 lg:w-1/2 lg:mb-0'>
              <div className='w-full px-6 lg:w-1/2'>
                <ul>
                  <li>
                    <RedirectLink text='Components' />
                  </li>
                  <li className='mt-6'>
                    <RedirectLink text='Templates' />
                  </li>
                  <li className='mt-6'>
                    <RedirectLink text='Pricing' />
                  </li>
                  <li className='mt-6'>
                    <RedirectLink text='FAQ' />
                  </li>
                  <li className='mt-6'>
                    <RedirectLink text='Documentation' />
                  </li>
                </ul>
              </div>
              <div className='w-full px-6 lg:w-1/2'>
                <ul>
                  <li>
                    <RedirectLink text='Free components' />
                  </li>

                  <li className='mt-6'>
                    <RedirectLink text='Blog' />
                  </li>
                  <li className='mt-6'>
                    <RedirectLink text='Change Log' />
                  </li>
                </ul>
              </div>
            </div>
            <div className='flex w-full lg:w-1/2'>
              <div className='w-full px-6 lg:w-1/2'>
                <ul>
                  <li>
                    <RedirectLink text='Privacy policy' />
                  </li>
                  <li className='mt-6'>
                    <RedirectLink text='Terms of service' />
                  </li>
                </ul>
              </div>
