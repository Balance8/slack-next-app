                ...
                <ul>
                  <li>
                    <Link href='javascript:void(0)'>
                      <a className='text-xs leading-none text-gray-800 lg:text-sm hover:text-brand dark:hover:text-brand dark:text-gray-50'>
                        Components
                      </a>
                    </Link>
                  </li>
                  ...
                  <li className='mt-6'>
                    <a
                      ...
                      className='text-xs leading-none text-gray-800 lg:text-sm hover:text-brand dark:hover:text-brand dark:text-gray-50'
                    >
                      Documentation
                    </a>
                  </li>
              ...
              <div className='flex flex-col justify-between w-full px-6 lg:w-1/2'>
                <div className='flex items-center mb-6'>
                  ...
                  <a href='javascript:void(0)'>
                    <div className='pl-4'>
                      <svg
                        className='text-gray-800 cursor-pointer footer-icon feather feather-twitter dark:text-gray-50 hover:text-brand dark:hover:text-brand '
                        xmlns='http://www.w3.org/2000/svg'
                        width={24}
                        height={24}
                        viewBox='0 0 24 24'
                ...
                <div className='relative w-36'>
                  ...
                  <select
                    ...
                    className='flex items-center w-full h-12 py-2 pl-10 text-sm leading-5 border border-gray-700 rounded appearance-none focus:outline-none dark:border-gray-50 dark:bg-gray-900 dark:text-gray-50'
                  >
